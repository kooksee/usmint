...
import (
	...
	ctypes "github.com/kooksee/usmint/server/core/types"
	rpccore "github.com/kooksee/usmint/server/core"
	cfg "github.com/kooksee/usmint/config"
...
func (n *Node) ConfigureRPC() {
	...
	rpccore.SetLogger(n.Logger.With("module", "core"))
}

func (n *Node) startRPC() ([]net.Listener, error) {
	/*
	不使用系统自带的jsonrpc系统,自己构建该API系统,同时实现权限管理
	 */
